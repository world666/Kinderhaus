...
<div class="container pad_seite1">
	<div class = "row row_pad">	
		...
		<p class="lead">Bei uns werden die Kinder in einer altersgemischten Gruppe betreut. Die überschaubare Gruppengröße mit dem guten Personalschlüssel  <em>(3 Erzieherinnen für 18 Kinder)</em>  ist ein großer Vorteil des Kinderhauses. </p>
		...
		<ul class="liste">
			<li>Die Kleinen</li>
			<li>Die Mittleren (3-4 jährige)</li>
			<li>Die Großen (Vorschulkinder)</li>
		</ul>
		</p>
		...
		<div class="col-md-4 ">
			<img src="img/group/group.jpg"  width="100%" class="featurette-image img-fluid mx-auto" data-src="holder.js/500x500/auto" alt="Unsere Gruppe" >
		</div>
	</div>
</div>