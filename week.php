...
<html lang="DE">
	...
	<body>
		...
		<div class="container pad_seite">
			...
			<div class = "row">	
				<div class="col-md-6">
					<img src="img/week/monday.png" style="display: block; margin: 0 auto;" width="50%" class="img-fluid mx-auto" alt="Montag" >
					<br>
					...
					<br>
					<img src="img/week/tuesday.png" style="display: block; margin: 0 auto;" width="50%" class="img-fluid mx-auto" alt="Dienstag" >
					<br>
					...
					<br>
					<img src="img/week/wednesday.png" style="display: block; margin: 0 auto;" width="50%" class="img-fluid mx-auto" alt="Mittwoch" >
					<br>
				...
				<div class="col-md-6">
					<img  src="img/week/thursday.png" style="display: block; margin: 0 auto;" width="50%" class="img-fluid mx-auto" alt="Donnerstag" >
					<br>
					...
					<br>
					<img  src="img/week/friday.png" style="display: block; margin: 0 auto;" width="50%" class="img-fluid mx-auto" alt="Freitag" >
					<br>
