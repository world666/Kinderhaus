  ...
  <head>
	...
	<body>
		...
		<div class="container pad_seite">		
			...
			<div class = "row">	
				<div class="col-md-2">
					<img class="img-responsive pull-right img_konzept" width="100%" src="img/concept/title1.png" alt="Worauf es uns ankommt">
				</div>
				<div class="col-md-10">
					<p class="lead">
			...
			<div class = "row row_pad">	
				<div class="col-md-2">
					<img class="img-responsive pull-right img_konzept" width="1-00%" style="float: center;"src="img/concept/title2.png" alt="Pädagogische Ziele unserer Arbeitt">
				</div>
				<div class="col-md-10">
					<p class="lead">
