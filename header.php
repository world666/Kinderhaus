<div class="row" style="background-color: #aaa; margin:0">
	<div class="container">
		<p class="header_adresse"><span class="fas fa-phone">&ensp;</span><span style="color: #fff;">  (06621) 74443 </span>&emsp;<span class="fas fa-envelope">&ensp;</span> <a href="mailto:info@kinderhaus-hersfeld.de" style="color: #fff;">info@kinderhaus-hersfeld.de</a></p>
	</div>
</div>
...
<div style="padding: 0" class="container">
	<a  href="index.php"><img src="img/header.jpg" class="img-fluid" width="100%" alt="Header"></a>
</div>
